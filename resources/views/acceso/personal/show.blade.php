...
@section('content_header')
    <h1><b>Detalle del Personal</b></h1>
    <hr>
    <br>
@stop
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white" value="{{ $staff->nombre }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $staff->telefono }}" name="telefono" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $staff->created_at->format('d/m/Y H:i:s') }}" name="date" disabled>
                            </div>
                        </div>
                    </div>
                    <hr>
