...
@section('content_header')
    <h1><b>Añadir Pago - Servicios</b></h1>
    <hr>
    <br>
@stop
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title my-1">Servicios</h3>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($entry->servicioConsumo->detalles as $detalle)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ $detalle->servicio ? $detalle->servicio->nombre : 'N/A' }}</td>
            ...
            <div class="card card-outline card-primary">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge badge-danger">$
                        {{ number_format($entry->servicioConsumo ? $entry->servicioConsumo->total : 0, 2) }}</span>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 text-right">
                            <p class="mb-1">$
                                {{ number_format($entry->servicioConsumo ? $entry->servicioConsumo->total : 0, 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            // Inicializar DataTable para Servicios
            var table = $('#servicio-table').DataTable({
                "paging": false,
                "lengthChange": false,
                "searching": false,
                "ordering": true,
            ...
            $(document).on('click', '.badge-danger', function() {
                ...
                Swal.fire({
                    title: '¿Está seguro en pagar este servicio?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ url('servicio-consumo/pagar-detalle') }}/' +
                                detalleId,
                            method: 'POST',
                            data: {
