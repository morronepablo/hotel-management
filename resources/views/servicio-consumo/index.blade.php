            ...
            @if ($entry->servicioConsumo && $entry->servicioConsumo->detalles->isNotEmpty())
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-secondary">
                        <div class="inner">
                            ...
                            <div class="two-columns">
                                ...
                                <div class="left-column">
                                    ...
                                    <p class="entry-dates">
                                        F. Entrada: {{ \Carbon\Carbon::parse($entry->check_in)->format('d/m/Y H:i') }}
                                    </p>
                                </div>
                                ...
                                <div class="right-column">
                                    <span style="font-size: 12px;">
                                        ...
                                        {{ number_format($entry->servicioConsumo->detalles->sum('subtotal'), 2, '.', ',') }}
                                    </span><br>
                                    <span style="font-size: 12px;">
                        ...
                        <a href="{{ route('servicio-consumo.create', $entry->id) }}" class="small-box-footer">
