        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title my-1">Productos registrados</h3>
                    <div class="card-tools">
                        <a href="{{ route('almacen.producto.create') }}" class="btn btn-primary btn-sm"><i
                                class="fa fa-plus"></i> Crear nuevo</a>
                    </div>
                </div>

                <div class="card-body">
                    <table id="producto-table" class="table table-striped table-bordered table-hover table-sm">
...
@section('css')
    <style>
        ...
        #producto-table_wrapper .dt-buttons {
            margin-bottom: 20px;
        }
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            table.buttons().container().appendTo('#producto-table_wrapper .col-md-12:eq(1)');
        });
