    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ route('almacen.servicio.update', $servicio->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nombre', $servicio->nombre) }}" name="nombre" required>
                                    @error('nombre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('precio', $servicio->precio) }}" name="precio" required>
                                    @error('precio')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
