        ...
        <div class="col-md-8">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title my-1">Servicios registrados</h3>
                    <div class="card-tools">
                        <a href="{{ route('almacen.servicio.create') }}" class="btn btn-primary btn-sm"><i
                                class="fa fa-plus"></i> Crear nuevo</a>
                    </div>
                </div>

                <div class="card-body">
                    <table id="servicio-table" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ route('almacen.servicio.show', $servicio->id) }}"
                                                class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Ver Servicio">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('almacen.servicio.edit', $servicio->id) }}"
                                                class="btn btn-success btn-sm" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Editar Servicio">
                                                <i class="fas fa-pencil"></i>
                                            </a>
                                            <form action="{{ route('almacen.servicio.destroy', $servicio->id) }}"
                                                method="POST" onclick="preguntar{{ $servicio->id }}(event)"
                                                id="miFormulario{{ $servicio->id }}">
                                                @csrf
                                                @method('DELETE')
...
@section('css')
    <style>
        ...
        #servicio-table_wrapper .dt-buttons {
            margin-bottom: 20px;
        }
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            table.buttons().container().appendTo('#servicio-table_wrapper .col-md-12:eq(1)');
        });
