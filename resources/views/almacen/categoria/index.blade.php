        ...
        <div class="col-md-6">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title my-1">Categorías registradas</h3>
                    <div class="card-tools">
                        <a href="{{ route('almacen.categoria.create') }}" class="btn btn-primary btn-sm"><i
                                class="fa fa-plus"></i> Crear nuevo</a>
                    </div>
                </div>

                <div class="card-body">
                    <table id="categoria-table" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ route('almacen.categoria.show', $categoria->id) }}"
                                                class="btn btn-info btn-sm" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="Ver Categoría">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('almacen.categoria.edit', $categoria->id) }}"
                                                class="btn btn-success btn-sm" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Editar Categoría">
                                                <i class="fas fa-pencil"></i>
                                            </a>
                                            <form action="{{ route('almacen.categoria.destroy', $categoria->id) }}"
...
@section('css')
    <style>
        ...
        #categoria-table_wrapper .dt-buttons {
            margin-bottom: 20px;
        }
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            table.buttons().container().appendTo('#categoria-table_wrapper .col-md-12:eq(1)');
        });
