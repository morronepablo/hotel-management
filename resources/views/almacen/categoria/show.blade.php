...
@section('content_header')
    <h1><b>Detalle de la Categoría</b></h1>
    <hr>
    <br>
@stop
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $categoria->denominacion }}" name="denominacion" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $categoria->created_at->format('d/m/Y H:i:s') }}" name="date" disabled>
                            </div>
                        </div>
                    </div>
                    <hr>
