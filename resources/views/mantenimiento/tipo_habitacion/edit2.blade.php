...
@section('content_header')
    <h1><b>Actualizar tipo de habitación</b></h1>
    <hr>
    <br>
@stop
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ route('mantenimiento.tipo_habitacion.update', $roomType->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('name', $roomType->name) }}" name="name" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('price_4_hours', $roomType->price_4_hours) }}" name="price_4_hours">
                                    @error('price_4_hours')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('price_full_night', $roomType->price_full_night) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('price_month', $roomType->price_month) }}" name="price_month">
                                    @error('price_month')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
