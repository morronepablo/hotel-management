...
@section('content_header')
    <h1><b>Registro de nueva habitación</b></h1>
    <hr>
    <br>
@stop
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('mantenimiento.habitacion.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('room_number') }}" name="room_number" id="room_number" required>
                                    @error('room_number')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('status') ? 'is-invalid' : '' }}"
                                        ...
                                        <option value="Ocupada" {{ old('status') == 'Ocupada' ? 'selected' : '' }}>
                                            Ocupada
                                        </option>
                                        <option value="Para la Limpieza"
                                            {{ old('status') == 'Para la Limpieza' ? 'selected' : '' }}>
                                            Para la Limpieza
                                        </option>
                                        <option value="Limpieza Profunda"
                                            {{ old('status') == 'Limpieza Profunda' ? 'selected' : '' }}>
                                            Limpieza Profunda
                                        </option>
                                        <option value="Limpieza Rápida"
                                            {{ old('status') == 'Limpieza Rápida' ? 'selected' : '' }}>
                                            Limpieza Rápida
                                        </option>
                                    </select>
                                    @error('status')
