            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createRoleModal">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="#" class="btn btn-info btn-sm" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Ver Rol">
                                            ...
                                            <form action="{{ route('roles.destroy', $role->id) }}" method="POST"
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar Rol"
