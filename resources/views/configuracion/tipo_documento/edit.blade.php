...
@section('content_header')
    <h1><b>Actualizar tipo de documento</b></h1>
    <hr>
    <br>
@stop
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ route('configuracion.tipo_documento.update', $tipoDocumento->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nombre', $tipoDocumento->nombre) }}" name="nombre" required>
                                    @error('nombre')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('longitud', $tipoDocumento->longitud) }}" name="longitud" required>
                                    @error('longitud')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
