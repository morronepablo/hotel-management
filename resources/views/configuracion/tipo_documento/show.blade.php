...
@section('content_header')
    <h1><b>Detalle del Tipo de Documento</b></h1>
    <hr>
    <br>
@stop
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $tipoDocumento->nombre }}" name="nombre" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $tipoDocumento->longitud }}" name="longitud" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $tipoDocumento->created_at->format('d/m/Y H:i:s') }}" name="date" disabled>
                            </div>
                        </div>
                    </div>
                    <hr>
