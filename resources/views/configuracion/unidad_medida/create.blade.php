...
@section('content_header')
    <h1><b>Registro de nueva unidad de medida</b></h1>
    <hr>
    <br>
@stop
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-9">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('configuracion.unidad_medida.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('valor_unidad') }}" name="valor_unidad" required>
                                    @error('valor_unidad')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
