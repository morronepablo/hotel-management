...
@section('content_header')
    <h1><b>Detalle de la Unidad de Medida</b></h1>
    <hr>
    <br>
@stop
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $unidadMedida->nombre }}" name="nombre" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $unidadMedida->valor_unidad }}" name="valor_unidad" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-info bg-white"
                                    value="{{ $unidadMedida->created_at->format('d/m/Y H:i:s') }}" name="date" disabled>
                            </div>
                        </div>
                    </div>
                    <hr>
